...
{       		
    	...
    	ta0 = 6150;	    // Set up Timer A1 Reload Register  interval
			    // for a LED refresh rate of 100Hz
}
...
p1a :			
		...
		vett16_dati[0]=acqNumero (vett16_dati[0],65000,1,rig3+25);		
		if (VTAS== F4)
...
p2a :		
		...
		vett16_dati[1]=acqNumero (vett16_dati[1],65000,1,rig4+25);			
		if (VTAS== F4)
		goto fine_programmazione;		
		if (VTAS== F3){
			clriga(4);
...
p3a:		
		...
		vett16_dati[2]=acqNumero (vett16_dati[2],65000,1,rig5+25);		
		if (VTAS== F4)
		goto fine_programmazione;
		if (VTAS== F3){
			clriga(5);
...
p4a:
		...
		vett16_dati[3]=acqNumero (vett16_dati[3],65000,1,rig6+25);
		if (VTAS== F4)
		goto fine_programmazione;
		if (VTAS== F3){
			clriga(6);
...
p5a:	
		...
		vett16_dati[4]=acqNumero (vett16_dati[4],65000,1,rig7+25);		
		if (VTAS== F4)
		goto fine_programmazione;
		if (VTAS== F3){
			clriga(7);
...
p6a:
		...
		vett16_dati[5]=acqNumero (vett16_dati[5],65000,1,rig8+25);
		if (VTAS== F4)
		goto fine_programmazione;		
		if (VTAS== F3){
			clriga(8);
...
p7a:	
		...
		vett16_dati[32]=acqNumero (vett16_dati[32],65000,1,rig9+25);
		if (VTAS== F4)
		goto fine_programmazione;		
		if (VTAS== F3){
			clriga(9);
...
p8a:	
		ind_wr=rig10;
		scrivi_riga_l ("Per.max-cam1               mB ");
		vett16_dati[33]=acqNumero (vett16_dati[33],65000,1,rig10+25);
		if (VTAS== F4)
		goto fine_programmazione;
		if (VTAS== F3){
			clriga(10);
...
p9a:
		...
		vett16_dati[34]=acqNumero (vett16_dati[34],65000,1,rig11+25);
		if (VTAS== F4)
		goto fine_programmazione;		
		if (VTAS== F3){
			clriga(11);
...
p10a:	
		ind_wr=rig12;
		scrivi_riga_l ("Per.max-cam2               mB ");
		vett16_dati[35]=acqNumero (vett16_dati[35],65000,1,rig12+25);
		if (VTAS== F4)
		goto fine_programmazione;		
		if (VTAS== F3){
			clriga(12);
...
// press min cam1	prova 1	
		...
		vett16_dati[18]=acqNumero (vett16_dati[18],65000,1,rig3+21);
		}
...
p12a:
		...
		vett16_dati[20]=acqNumero (vett16_dati[20],65000,1,rig4+21);
		}
...
p13a:
		...
		vett16_dati[19]=acqNumero (vett16_dati[19],65000,1,rig5+21);
		}
...
p14a:
		...
		vett16_dati[21]=acqNumero (vett16_dati[21],65000,1,rig6+21);
		}
...
// ch tappo			
		...
		vett16_dati[7]=acqNumero(vett16_dati[7],65000,1,rig3+25);			
		if (VTAS== F4)
		goto fine_programmazione;		
		if (VTAS== F3){
			clriga(3);
...
p2b:		
		ind_wr=rig4;
		scrivi_riga_l ("Tempo imiss.               s");
		vett16_dati[8]=acqNumero (vett16_dati[8],65000,1,rig4+25);		
		if (VTAS== F4)
		goto fine_programmazione;
			if (VTAS== F3){
			clriga(4);
...
p3b:
		ind_wr=rig5;
		scrivi_riga_l ("Tempo stabil.              s");
		vett16_dati[9]=acqNumero (vett16_dati[9],65000,1,rig5+25);
		if (VTAS== F4)
		goto fine_programmazione;
		if (VTAS== F3){
			clriga(5);
...
p4b:		
		ind_wr=rig6;
		scrivi_riga_l ("Tempo prova.               s");
		vett16_dati[10]=acqNumero (vett16_dati[10],65000,1,rig6+25);		
		if (VTAS== F4)
		goto fine_programmazione;
		if (VTAS== F3){
			clriga(6);
...
p5b:
		ind_wr=rig7;
		scrivi_riga_l ("Tempo sfiato               s");
		vett16_dati[11]=acqNumero (vett16_dati[11],65000,1,rig7+25);
		if (VTAS== F4)
		goto fine_programmazione;		
		if (VTAS== F3){
			clriga(7);
...
p6b:		
		...
		vett16_dati[36]=acqNumero (vett16_dati[36],65000,1,rig8+25);
		if (VTAS== F4)
		goto fine_programmazione;
		if (VTAS== F3){
			clriga(8);
...
p7b:		
		ind_wr=rig9;
		scrivi_riga_l ("Per.max-camera             mB ");
		vett16_dati[37]=acqNumero (vett16_dati[37],65000,1,rig9+25);
		if (VTAS== F4)
		goto fine_programmazione;
		if (VTAS== F3){
			clriga(9);
...
p8b:
		...
		vett16_dati[22]=acqNumero (vett16_dati[22],65000,1,rig10+25);
		}
...
p9b:
		...
		vett16_dati[23]=acqNumero (vett16_dati[23],65000,1,rig11+25);
		}
...
// ch tappo
		...
		ind_wr=rig3;
		scrivi_riga_l ("Tempo chiusura tappo       s");
		vett16_dati[13]=acqNumero (vett16_dati[13],65000,1,rig3+25);			
		if (VTAS== F4)
		goto fine_programmazione;		
		if (VTAS== F3){
		clriga(3);
...
p1c:		
		ind_wr=rig4;
		scrivi_riga_l ("Tempo imiss.               s");
		vett16_dati[14]=acqNumero (vett16_dati[14],65000,1,rig4+25);		
		if (VTAS== F4)
		goto fine_programmazione;
		if (VTAS== F3){
			clriga(4);
...
p2c:
		ind_wr=rig5;
		scrivi_riga_l ("Tempo stabil.              s");
		vett16_dati[17]=acqNumero (vett16_dati[17],65000,1,rig5+25);
		if (VTAS== F4)
		goto fine_programmazione;
		if (VTAS== F3){
			clriga(5);
...
p3c:		
		ind_wr=rig6;
		scrivi_riga_l ("Tempo prova.               s");
		vett16_dati[15]=acqNumero (vett16_dati[15],65000,1,rig6+25);		
		if (VTAS== F4)
		goto fine_programmazione;
		if (VTAS== F3){
			clriga(6);
...
p4c:
		ind_wr=rig7;
		scrivi_riga_l ("Tempo sfiato               s");
		vett16_dati[16]=acqNumero (vett16_dati[16],65000,1,rig7+25);
		if (VTAS== F4)
		goto fine_programmazione;
		if (VTAS== F3){
			clriga(7);
...
p5c:		
		ind_wr=rig8;
		scrivi_riga_l ("Per.max+camera             mB ");
		vett16_dati[38]=acqNumero (vett16_dati[38],65000,1,rig8+25);
		if (VTAS== F4)
		goto fine_programmazione;
		if (VTAS== F3){
			clriga(8);
...
p6c:
		...
		ind_wr=rig9;
		scrivi_riga_l ("Per.max-camera             mB ");
		vett16_dati[39]=acqNumero (vett16_dati[39],65000,1,rig9+25);
		if (VTAS== F4)
		goto fine_programmazione;		
		if (VTAS== F3){
			clriga(9);
...
p7c:	
		...
		ind_wr=rig10;
		scrivi_riga_l ("Press.min. camera           B ");
		vett16_dati[24]=acqNumero (vett16_dati[24],65000,1,rig10+25);
		}
...
p8c:
		...
		ind_wr=rig11;
		scrivi_riga_l ("Press.max. camera           B ");
		vett16_dati[25]=acqNumero (vett16_dati[25],65000,1,rig11+25);
		}
...
p12c:
		...
		vett16_dati[44]=acqNumero(vett16_dati[44],65000,1,rig10+24);
		}
...
p15c:		
		...
		do
		{
		vett16_dati[46] =acqNumero( vett16_dati[46],65000,1,rig7+24);
		}
...
p16c:		
		...
		do
		{
		vett16_dati[47] =acqNumero ( vett16_dati[47],65000,1,rig10+24);
		}
...
p17c:
		...
		vett16_dati[48] =acqNumero( vett16_dati[48],65000,1,rig12+24);
		if (VTAS== F4)
		goto fine_programmazione;
		if (VTAS== F3){
			clriga(12);
...
// líndirizzo passato e'quello della cifra + signif.
...
char i,app, app_v;
long num_int;
		punt_hex32=&(vett_hex32[16]);			// inizializza puntatore all'ultimo elemento
		for (i=0;i<16;i++){					// azzera VETTORE
			vett_hex32[i]=0;
		}
		
		for (i=0; i<8;i++){
			num_int=(char)numero & 0xFF;
			numero=numero >> 8;				// schifta il Byte
			app=num_int  & 0x0F;
			app_v=tab_hex[app][1];
			*punt_hex32=app_v;
			punt_hex32--;
